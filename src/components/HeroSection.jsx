// src/components/HeroSection.jsx - PERBAIKAN RESPONSIVE & KONTRAST
...
return (
    // PERBAIKAN: Background lebih gelap untuk kontras teks yang baik
    <div className="relative w-full min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 pb-32 pt-24">
        ...
        {/* A. BACKGROUND CAROUSEL - PERBAIKAN OPACITY */}
        {slides.map((slide, index) => (
            <div 
                key={slide.id}
                className={`absolute inset-0 w-full h-full transition-opacity duration-1000 ease-in-out ${
                    index === currentSlide ? 'opacity-40' : 'opacity-0' // PERBAIKAN: opacity lebih tinggi
                }`}
            >
                <img 
                    src={slide.image} 
                    ...
                    loading="lazy"
                />
                {/* OVERLAY UNTUK KONTRAST TEKS - PERBAIKAN */}
        ...
        <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center w-full">
            ...
            {/* 2. Headline - PERBAIKAN BESAR UNTUK MOBILE */}
            ...
            {/* 3. Subheadline - PERBAIKAN RESPONSIVE */}
            ...
            {/* 4. Action Buttons - PERBAIKAN RESPONSIVE BESAR */}
            ...
            {/* 5. VOUCHER CARD - PERBAIKAN RESPONSIVE */}
            <div 
                className="relative group overflow-hidden rounded-xl sm:rounded-2xl border border-white/10 bg-black/50 backdrop-blur-xl p-1 max-w-xs xs:max-w-sm sm:max-w-md cursor-pointer transition-all hover:border-primary/50 shadow-2xl active:scale-95"
            ...
            {/* 6. Indikator Slide */}
            <div className="absolute bottom-6 sm:bottom-10 flex gap-2 sm:gap-3 z-30">
                {slides.map((_, idx) => (
                    <button 
                        key={idx}
            ...
            {/* 7. Scroll Indicator */}
            <div className="absolute bottom-2 sm:bottom-4 animate-bounce">
